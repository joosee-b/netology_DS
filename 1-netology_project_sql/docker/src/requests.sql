...
-- Запрос 3.1 - Вывести авторов по годам публикаций
...
-- Запрос 3.2 - Вывести первый и последний год публикации авторов
...
-- Запрос 3.3 - Вывести список книг по количеству рецензий
...
-- Запрос 3.4 - Вывести средний рейтинг по пользователям, для пользователей, которые голосовали больше, чем за 10 фильмов и средний рейтинг у которых больше 2, но меньше 5
SELECT user_id, 
...
-- Запрос 3.5 - Вывести список книг по среднему рейтингу
...
-- Запрос 3.6 - Вывести список авторов по общему количеству рецензий по написанным автором книгам
...
-- Запрос 3.8 - Вывести количество оценок у каждой книги
...
-- Запрос 3.9 - Вывести количество оценок у каждого автора по всем написанным книгам
WITH t_count_rating_books as
...
-- Представление 4.1 - Представление с годами публикаций авторов
